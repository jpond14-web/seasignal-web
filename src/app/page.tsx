      ...
      <main className="flex-1 flex flex-col items-center">
        <section className="relative w-full flex flex-col items-center px-6 pt-20 pb-4 text-center">
          ...
          <p className="relative text-slate-400 mt-5 max-w-xl text-lg leading-relaxed">
            The privacy-first professional network for seafarers. No employer access &mdash; ever. Share intel, track pay, and protect each other.
          </p>
        ...
        <section id="features" className="w-full max-w-5xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <FeatureCard
              ...
              description="Control who can verify your credentials. Port state authorities get instant checks — on your terms."
            />
            <FeatureCard
              icon={<HeartPulseIcon />}
              title="Wellness Monitor"
              description="Track fatigue, stress, and morale. Spot contract strain early and protect your wellbeing."
            />
          </div>
        </section>
