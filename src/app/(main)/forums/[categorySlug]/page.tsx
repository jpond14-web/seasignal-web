...
export default function CategoryPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Link href="/forums" className="text-sm text-slate-400 hover:text-slate-300 mb-4 inline-block">&larr; Forums</Link>

      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold capitalize">{categoryName || categorySlug}</h1>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {posts.map((post) => (
            <Link key={post.id} href={`/forums/post/${post.id}`}
