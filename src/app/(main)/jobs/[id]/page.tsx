...
export default function JobDetailPage() {
  ...
  if (!job) {
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <Link href="/jobs" className="text-teal-400 hover:text-teal-300 text-sm mt-2 inline-block">
          Back to Job Board
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Link href="/jobs" className="text-sm text-slate-400 hover:text-slate-300 mb-4 inline-block">
        &larr; Job Board
      </Link>
